    ...
    public void test01() {
     ...
     //BlueRentalCar sayfasına gidip login olalım
      String dosyaYolu = "src/test/java/techproed/resources/mysmoketestdata.xlsx";
        ...
        //Bir loop oluşturup excel doyasındaki tüm veriler ile login olalım
        for (int i = 1; i <= reader.rowCount() ; i++) {//-->i'yi 1'den başlattık cünkü veriler 1. satırdan başlıyor
